...
{
    public class UpdateRequestROLEViewModel : BaseViewModel
    {
        #region Services
        ...
        #region Constructor
        public UpdateRequestROLEViewModel()
        {
        ...
        public async void GetRequest()
        {
            ...
            MessagingCenter.Subscribe<PassIdPatient>(this, "UpdateRequestRole", async (value) =>
            {
