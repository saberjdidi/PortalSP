...
{
   public class BillingExtractionViewModel : BaseViewModel
    {
        #region Services
        ...
        #region Constructors
        public BillingExtractionViewModel()
        {
        ...
        public ICommand DownloadBillingExtraction
        {
            get
            {
                return new Command(async () =>
                {
                    try
                    {
                        ...
                        var url = "https://portalesp.smart-path.it/Portalesp/request/exportExcel";
                        Debug.WriteLine("********url*************");
                        Debug.WriteLine(url);
