...
{
   public class ArchiveRequestRoleViewModel : BaseViewModel
    {
        #region Services
        ...
        #region Constructors
        public ArchiveRequestRoleViewModel()
        {
        ...
        public async void GetList()
        {
            ...
            var response = await apiService.GetListWithCoockie<string>(
                 ...
                 "/Portalesp",
                 "/biologicalMaterial/getBarCodeByRequest?requestId=" + Attachment.requests.Select(r => r.id).FirstOrDefault(),
                 res);
