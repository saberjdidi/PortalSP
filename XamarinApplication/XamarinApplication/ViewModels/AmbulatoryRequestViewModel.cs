...
{
   public class AmbulatoryRequestViewModel : BaseViewModel
    {
        #region Services
        ...
        #region Constructors
        public AmbulatoryRequestViewModel()
        {
        ...
        public async void GetAmbulatoryRequest()
        {
            ...
            var response = await apiService.GetAttachmentWithCoockie<AmbulatoryRequest>(
                 ...
                 "/Portalesp",
                 "/ambulatoryRequest/getByRequest?requestId=" + Request.id,
                 res);
        ...
        public async void AddAmbulatory()
        {
            ...
            Debug.WriteLine(Request.id);
           /* DateTime BirthDate = DateTime.ParseExact(DateTime.Now.ToString("dd-MM-yyyy"), "ddd MMM dd yyyy HH:mm:ss 'GMT+0000 (GMT Standard Time)'", System.Globalization.CultureInfo.InvariantCulture);
            Debug.WriteLine("********BirthDate*************");
            Debug.WriteLine(BirthDate);
            var date = DateTime.ParseExact(AmbulatoryRequest.sendDate, "ddd MMM dd yyyy HH:mm:ss 'GMT+0000 (GMT Standard Time)'",
           CultureInfo.InvariantCulture);
            ...
            var url = "https://portalesp.smart-path.it/Portalesp/ambulatoryRequest/create?ampId=" + Ambulatory.id + "&reqId=" + Request.id + "&usId=" + User.id + "&dt="+ DateTime.Now.ToString("ddd, dd MMM yyy HH’:’mm’:’ss ‘GMT’");
            Debug.WriteLine("********url*************");
             Debug.WriteLine(url);
