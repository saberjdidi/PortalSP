...
{
   public class NewConfigurationUploadCSVViewModel : BaseViewModel
    {
        #region Services
        ...
        #region Constructor
        public NewConfigurationUploadCSVViewModel()
        {
        ...
        public async void NewJobCron()
        {
            ...
            var response = await apiService.Save<AddConfigs>(
