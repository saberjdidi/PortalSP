...
{
   public class RequestAttachmentViewModel : BaseViewModel
    {
        #region Services
        ...
        public async void GetAttachmentRestrict()
        {
            ...
            var response = await apiService.GetAttachmentWithCoockie<AttachmentListRestrict>(
                 ...
                 "/Portalesp",
                 "/request/getAttachmentListRestrict?requestId=" + Request.id + "&clientId=" + Request.client.id,
                 res);
        ...
        #region Sigleton
        static RequestAttachmentViewModel instance;
        public static RequestAttachmentViewModel GetInstance()
        {
            if (instance == null)
            {
                return new RequestAttachmentViewModel();
            }
